...
<ul class="view display clearfix hidden-xs">
	<label class="hidden-sm">{l s='View as'}</label>
    <li id="grid"><a rel="nofollow" href="#" title="{l s='Grid'}"><span></span></a></li>
    <li id="list"><a rel="nofollow" href="#" title="{l s='List'}"><span></span></a></li>
</ul>
...
<form id="productsSortForm{if isset($paginationId)}_{$paginationId}{/if}" action="{$request|escape:'html':'UTF-8'}" class="productsSortForm">
	<div class="select selector1">
		<label class="hidden-xs" for="selectProductSort{if isset($paginationId)}_{$paginationId}{/if}"><span>{l s='Sort by'}</span></label>
