...
<div class="breadcrumb clearfix">
	...
	{if isset($path) AND $path}
		{* overriding pipe that is hardcoded in Tools::getPath *}
		{$fragment = '>'|cat:$navigationPipe|cat:'</span>'}
		{$navigationPipe = '|'}
		{$replacement = '>'|cat:$navigationPipe|cat:'</span>'}
...
<div class="wrap-search-back">
		<a href="{$smarty.server.HTTP_REFERER|escape}" name="back">
			<i class="fa fa-angle-left left"></i> {l s='Back to Search results for "%s" (%d other results)' sprintf=[$smarty.get.search_query,$smarty.get.results]}
		</a>
</div>
{/if}
<!-- /Breadcrumb -->