...
$(document).ready(function(){
	...
	$(window).resize(responsiveWidthThumbs);
	$('#product_comments_block_extra').appendTo('.wrap-comments');
...
function refreshProductImages(id_product_attribute)
{
	...
	if (parseInt($('#thumbs_list_frame >li:visible').length) != parseInt($('#thumbs_list_frame >li').length + 200))
...
function responsiveWidthThumbs(){
	...
	if (($(window).width() + scrollCompensate())>991){
		...
		widthElemThumb = widthThumbList/4;
	}else if(($(window).width() + scrollCompensate())>540){
		widthElemThumb = widthThumbList/4;
	}else{
