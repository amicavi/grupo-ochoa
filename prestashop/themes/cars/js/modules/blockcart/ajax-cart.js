...
var ajaxCart = {
		...
		$(jsonData.products).each(function(){
			...
			if (this.id != undefined)
			{
				...
				if ($('dt[data-id="cart_block_product_' + domIdProduct + '"]').length == 0)
				{
					...
					content += '<span class="quantity-formated"><span class="quantity-title">'+ qtyTitle +'</span><span class="quantity">' + this.quantity + '</span></span>';
	...
	updateLayer : function(product){
		...
		var heightPanel = $('.main_panel').outerHeight();
		var n = parseInt($(window).scrollTop()) + heightPanel + 'px';
