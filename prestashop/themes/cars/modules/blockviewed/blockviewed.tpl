...
<div id="viewed-products_block_left" class="block">
	<p class="title_block"><span>{l s='Viewed' mod='blockviewed'}</span></p>
	<div class="block_content">
		<ul class="clearfix">
			{foreach from=$productsViewedObj item=viewedProduct name=myLoop}
				<li class="item col-xs-6 col-sm-12 col-md-6 clearfix{if $smarty.foreach.myLoop.last} last_item{elseif $smarty.foreach.myLoop.first} first_item{else} item{/if}">
					<a
